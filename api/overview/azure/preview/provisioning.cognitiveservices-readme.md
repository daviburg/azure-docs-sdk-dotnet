...
keywords: Azure, dotnet, SDK, API, Azure.Provisioning.CognitiveServices, cognitiveservices
ms.date: 06/23/2026
ms.topic: reference
ms.devlang: dotnet
ms.service: cognitiveservices
---
# Azure Provisioning CognitiveServices client library for .NET - version 1.3.0-alpha.20260623.1 
