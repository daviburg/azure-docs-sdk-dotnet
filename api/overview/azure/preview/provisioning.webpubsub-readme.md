---
title: Azure Provisioning WebPubSub client library for .NET
keywords: Azure, dotnet, SDK, API, Azure.Provisioning.WebPubSub, webpubsub
ms.date: 07/01/2026
ms.topic: reference
ms.devlang: dotnet
ms.service: webpubsub
---
# Azure Provisioning WebPubSub client library for .NET - version 1.2.0-alpha.20260630.1 
