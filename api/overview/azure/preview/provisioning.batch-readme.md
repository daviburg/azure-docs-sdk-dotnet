---
title: Azure Provisioning Batch client library for .NET
keywords: Azure, dotnet, SDK, API, Azure.Provisioning.Batch, batch
ms.date: 06/22/2026
ms.topic: reference
ms.devlang: dotnet
ms.service: batch
---
# Azure Provisioning Batch client library for .NET - version 1.0.0-alpha.20260622.1 
