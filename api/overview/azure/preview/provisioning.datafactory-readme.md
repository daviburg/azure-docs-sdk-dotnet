---
title: Azure Provisioning DataFactory client library for .NET
keywords: Azure, dotnet, SDK, API, Azure.Provisioning.DataFactory, datafactory
ms.date: 06/25/2026
ms.topic: reference
ms.devlang: dotnet
ms.service: datafactory
---
# Azure Provisioning DataFactory client library for .NET - version 1.0.0-alpha.20260625.1 
