---
title: Azure Provisioning Search client library for .NET
keywords: Azure, dotnet, SDK, API, Azure.Provisioning.Search, search
ms.date: 06/22/2026
ms.topic: reference
ms.devlang: dotnet
ms.service: search
---
# Azure Provisioning Search client library for .NET - version 1.1.0-alpha.20260622.1 
