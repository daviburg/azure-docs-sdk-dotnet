---
title: Azure Storage Files Shares Change Feed client library for .NET
keywords: Azure, dotnet, SDK, API, Azure.Storage.Files.Shares.ChangeFeed, storage
ms.date: 06/23/2026
ms.topic: reference
ms.devlang: dotnet
ms.service: storage
---
# Azure Storage Files Shares Change Feed client library for .NET - version 12.0.0-alpha.20260623.2 
