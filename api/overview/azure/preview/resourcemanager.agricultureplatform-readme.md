---
title: 
keywords: Azure, dotnet, SDK, API, Azure.ResourceManager.AgriculturePlatform, agricultureplatform
ms.date: 06/29/2026
ms.topic: reference
ms.devlang: dotnet
...
Install the Microsoft Azure AgriculturePlatform management library for .NET with [NuGet](https://www.nuget.org/):

```dotnetcli
dotnet add package Azure.ResourceManager.AgriculturePlatform --prerelease
```
