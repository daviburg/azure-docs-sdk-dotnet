---
title: Azure Provisioning Kubernetes client library for .NET
keywords: Azure, dotnet, SDK, API, Azure.Provisioning.Kubernetes, hybridkubernetes
ms.date: 07/01/2026
ms.topic: reference
ms.devlang: dotnet
ms.service: hybridkubernetes
---
# Azure Provisioning Kubernetes client library for .NET - version 1.0.0-alpha.20260630.1 
