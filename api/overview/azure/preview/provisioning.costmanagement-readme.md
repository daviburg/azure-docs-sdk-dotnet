---
title: Azure Provisioning CostManagement client library for .NET
keywords: Azure, dotnet, SDK, API, Azure.Provisioning.CostManagement, costmanagement
ms.date: 06/29/2026
ms.topic: reference
ms.devlang: dotnet
ms.service: costmanagement
---
# Azure Provisioning CostManagement client library for .NET - version 1.0.0-alpha.20260629.2 


Azure.Provisioning.CostManagement simplifies declarative resource provisioning for Azure Cost Management in .NET.
...
```dotnetcli
dotnet add package Azure.Provisioning.CostManagement --prerelease
```
