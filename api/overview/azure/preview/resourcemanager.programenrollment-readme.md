---
title: 
keywords: Azure, dotnet, SDK, API, Azure.ResourceManager.ProgramEnrollment, programenrollment
ms.date: 07/01/2026
ms.topic: reference
ms.devlang: dotnet
...
Install the Azure.ResourceManager.ProgramEnrollment management library for .NET with [NuGet](https://www.nuget.org/):

```dotnetcli
dotnet add package Azure.ResourceManager.ProgramEnrollment --prerelease
```
