---
title: 
keywords: Azure, dotnet, SDK, API, Azure.ResourceManager.Monitor.PipelineGroups, monitorpipelinegroups
ms.date: 07/01/2026
ms.topic: reference
ms.devlang: dotnet
ms.service: monitorpipelinegroups
---
# Microsoft Azure Monitor pipelines management client library for .NET
...
```dotnetcli
dotnet add package Azure.ResourceManager.Monitor.PipelineGroups
```
