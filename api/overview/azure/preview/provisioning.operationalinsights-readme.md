...
keywords: Azure, dotnet, SDK, API, Azure.Provisioning.OperationalInsights, operationalinsights
ms.date: 06/27/2026
ms.topic: reference
ms.devlang: dotnet
ms.service: operationalinsights
---
# Azure Provisioning OperationalInsights client library for .NET - version 1.2.0-alpha.20260626.3 
