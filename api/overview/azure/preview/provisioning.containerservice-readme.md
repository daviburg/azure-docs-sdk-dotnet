...
keywords: Azure, dotnet, SDK, API, Azure.Provisioning.ContainerService, containerservice
ms.date: 06/25/2026
ms.topic: reference
ms.devlang: dotnet
ms.service: containerservice
---
# Azure Provisioning ContainerService client library for .NET - version 1.0.0-alpha.20260625.1 
