---
title: Azure Provisioning EventHubs client library for .NET
keywords: Azure, dotnet, SDK, API, Azure.Provisioning.EventHubs, eventhub
ms.date: 06/24/2026
ms.topic: reference
ms.devlang: dotnet
ms.service: eventhub
---
# Azure Provisioning EventHubs client library for .NET - version 1.2.0-alpha.20260624.1 
