---
title: Azure Provisioning Redis client library for .NET
keywords: Azure, dotnet, SDK, API, Azure.Provisioning.Redis, redis
ms.date: 06/23/2026
ms.topic: reference
ms.devlang: dotnet
ms.service: redis
---
# Azure Provisioning Redis client library for .NET - version 1.2.0-alpha.20260623.1 
