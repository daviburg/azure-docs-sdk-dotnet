---
title: Azure Planetary Computer client library for .NET
keywords: Azure, dotnet, SDK, API, Azure.Analytics.PlanetaryComputer, planetarycomputer
ms.date: 07/01/2026
ms.topic: reference
ms.devlang: dotnet
ms.service: planetarycomputer
---
# Azure Planetary Computer client library for .NET - version 1.0.0-alpha.20260701.2 
...
This library uses the standard .NET [EventSource](/dotnet/api/system.diagnostics.tracing.eventsource) for logging. Logs can be enabled by adding the following to your application:
