...
keywords: Azure, dotnet, SDK, API, Azure.Provisioning.AppConfiguration, appconfiguration
ms.date: 06/29/2026
ms.topic: reference
ms.devlang: dotnet
ms.service: appconfiguration
---
# Azure Provisioning AppConfiguration client library for .NET - version 1.2.0-alpha.20260629.1 
